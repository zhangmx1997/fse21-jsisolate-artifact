...
CONFIG_FILE=url.configs-simple FALLBACK_CONTEXT=1 POLICY_MODE=1 ./chrome --no-sandbox http://www.google.com
```
...
We have released the object access logs and the script isolation policies generated by JSIsolate [here](https://zenodo.org/record/4892853), with a DOI of __10.5281/zenodo.4892853__.
